      ...
      <div id="formContainer" >
        <div id="form-Login">
          ...
          >
            ...
            <Form.Item >
              <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center'}} onClick={() => handleLink()} className="register"><span style={{marginRight: 5}}>Bạn là đơn vị camping? </span><Tag color="blue" className='register'>Đăng ký ngay</Tag></div>
            </Form.Item>
          </Form>
        </div>
